  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="px-12 py-8 text-lg font-semibold leading-relaxed w-full">
        ...
        <p className="text-black leading-relaxed">At Juume AI, we provide a unified security solution for all AI systems—Agentic, 
LLMs, and Open Source—designed to meet the highest enterprise standards out of 
the box. Our flexible framework aligns with state, DoD, and NIST AI security 
standards, ensuring consistent protection and eliminating the worry of disparate 
products applying different controls. Our platform delivers real-time threat 
detection and compliance, unifies AI agents into a cohesive system, and offers 
advanced capabilities like causality modeling, behavioral analysis, and risk alerts.
Our goal at Juume AI is to empower enterprises to bring AI to the forefront of 
business in an easy, quick, and most importantly, secure manner without concern. 
          ...
          <>
            ...
            <div className="flex flex-wrap gap-3">
              {job.technologies.map((tech, index) => (
                <span
                  key={index}
                  className="px-4 py-2 bg-gray-200 text-black font-semibold rounded-lg shadow"
                >
                  {tech}
                </span>
              ))}
